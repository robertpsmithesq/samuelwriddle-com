...
description: >-
  Upskill is a web platform to deliver curriculum to learners, teachers, and organizations. It is used to build and present courses that teach a wide range of skills through a series of lessons and assessments. The platform is used by companies, K12 schools, and higher-ed institutions to train students & employees on the latest technological trends and tools, helping these institutions achieve their goals for AI & data literacy.
tags:
  - Ruby on Rails
  - PostgreSQL
  - Tailwind CSS
...
I joined the Upskill engineering team in April 2025. Over the course of 17 months, I deployed more than 170 features and bug fixes to production. This article highlights the most important features I worked on, emphasizing the business impact of each feature.

## Context

QuantHub helps companies and educational institutions create the curriculum they need, with a focus on AI fluency and data literacy. Their curriculum development pipeline is significantly faster than traditional curriculum development teams (weeks instead of months). This speed matters because the topics QuantHub specializes in are changing very quickly.

Upskill is the delivery layer for QuantHub's curriculum. Within the platform are multiple "apps" to support different types of users:

- Their curriculum development team builds courses, including learning outcomes, case studies, and activities.
...
- Their customer success team leverages system-admin tools to set up these courses and resolve support tickets.
...
I worked as a full-stack developer on a team of nine, including a product manager, designer, engineering director, QA specialist, and five software developers. My team was responsible for:

- Designing and building new features that helped us onboard new customers & support existing ones
- Triaging and resolving critical application issues
- Shipping these features and bug fixes as quickly as possible

As a junior developer, my primary value was helping the team move quickly across a wide range of work. I started with quick wins, building expertise in advanced UI/UX patterns. Over time, I became trusted with high-stakes features that involved complex UI/UX requirements under tight deadlines. Furthermore, I was often asked to try out the newest tools and software development practices, especially ones that leverage AI.

My day-to-day work usually involved:
...
AI helped me move faster, especially considering that I had never worked with Ruby on Rails before joining the team. However, our process still depended on a lot of manual review, including code review, QA & acceptance testing. We used AI to generate code and discover issues quickly, but we did not treat it as a substitute for engineering judgment or product thinking.

## Tech Stack

Upskill is a Ruby on Rails monolith with PostgreSQL. The frontend is built primarily with Rails views & ViewComponents, using Tailwind CSS for styling and Hotwire/Turbo for interactivity. Other integrations included:
...
Because Upskill serves educational institutions, accessibility and reliability are not optional. We regularly evaluated our work against WCAG requirements, monitored production errors closely, and maintained dependency management policies that required security vulnerabilities to be patched before new feature releases. We also supported integrations with multiple LMS platforms via the LTI 1.3 Advantage spec.

## My Contributions

### Learner Homepage

One of my highest-impact areas was the learner homepage experience.
...
The business impact of these releases was helping us land some of QuantHub's first substantial higher education contracts, and the team still gets positive feedback about the modern learner experience during their sales demos.

One of the most important technical outcomes was my early work with Rails ViewComponent. As older Bulma-based UI patterns became harder to scale and maintain, we needed to 1) move toward more modern frontend frameworks, such as Tailwind and 2) build reusable components to standardize UI elements application-wide. Through this series of projects, I helped define how ViewComponent fit into the application, shaping the team's frontend conventions and best practices.

The most challenging part of this work was release pressure, as some of these homepage changes had ambitious timelines. To manage this challenge, I broke up the work into small pieces that could be quickly reviewed, tested, and released behind a feature flag. Because each change was scoped narrowly, my team could review each piece quickly, giving internal stakeholders steady visibility into progress without exposing customers to the risk of a large, disruptive release.

Overall, this work best represents the impact I had on Upskill: improving a core product experience, helping establish stronger frontend patterns, and supporting the sales momentum behind some of QuantHub's most important early customer relationships.

### Teacher Experience

Teachers, professors, and managers are usually the people responsible for deciding whether Upskill will be adopted by the organization. As a result, we spent a lot of time refining the teacher experience, because a clear, intuitive admin workflow supports both successful demos and long-term retention.

I was the lead developer on several major features contributing to the teacher experience, primarily the class roster.
...
The larger releases above are the easiest to show off, but I also contributed to several other important features:

**Teaching Guide**

![Teaching Guide](/assets/upskill/teacher_guide.png)

I took over the development of a dedicated guide page for teachers to understand the curriculum QuantHub built for them. This replaced a legacy guide component that presented resources for teachers directly on the learn page, which was both distracting and confusing. The new guide presented the same narratives and skills presented to students on the learn page, while also linking teachers to pre-filtered reports for their classes and giving them a peek into our curriculum delivery methodology.

**Reports**

I undertook a major effort to facelift Upskill's reports to make them conform to the new design system and decouple them from legacy functionality. While this effort improved users' visual experience with the platform, it also resolved a significant amount of tech debt we had as a team, paving the way for us to overhaul reports again in the future.
...
I built major navigation features, including the course switcher and app menu. These components made it easier for users to control what they're currently learning or teaching, and allowed users with multiple roles to move easily between different parts of the platform. While it significantly improved regular users' everyday workflows, it also addressed a critical need brought up by sales team members, who had identified that better ways to switch contexts were needed during demos.

**Content Delivery**

I worked on several features to help the curriculum development team present content in multiple formats, including organizing articles into series, attaching audio/video resources to skills in courses, and adding content blocks (such as email, app, and chatbot cues) to items during assessments. This work mattered because curriculum delivery is not just about storing content: it is about providing the student with the right material in the right format, so they can complete their assignments and actually understand the concepts.
...
I handled several bugs with timed assessments, leading to me becoming a local subject matter expert in this area. This work resolved discrepancies our team noticed when running reports for assessments, and it also made the visual cues provided during timed assessments more accurate, improving the user experience.

**Subscriptions**

One of my earliest features involved tracking subscriptions from students paying for courses through a third party. This work supported QuantHub's first higher-education contracts, which led to renewals from those customers and paved the way for onboarding new customers easily.

**Code Review**

I also started reviewing pull requests for senior engineers, meaning I either contributed to or reviewed 90% of all work done on Upskill within a 10-month period. This helped my team move faster because my reviews unblocked releases more quickly. It also helped me grow because I got more exposure to architectural decisions, newer parts of the codebase, and patterns I may not have encountered in my own feature work.

## Takeaway

Working on Upskill taught me that being a good engineer requires being a product owner. I shouldn't just build a feature because it's fun to build: if a feature doesn't make sense to me as I'm building it, it likely won't make sense to an end user. For example, a new feature for teachers wasn't successful just because the page loaded and it looked pretty: it was successful when a teacher logged in, understood what to do, and used the feature to improve their workflow. Having a product ownership mindset as an engineer is one of the best ways to ensure users will trust a platform.

It also taught me how much the release cadence matters when deploying features. Finishing features quickly matters, but shipping everything immediately isn't always the right decision; sometimes it's better to release a smaller version first, then ship the rest of the functionality quickly, so that customers have access to critical functionality quickly. In a fast-paced environment, good software engineers 1) make it work, 2) make it right, then 3) make it fast.

Most importantly, this project helped me grow from someone who could complete assigned work into someone who could shape the future of applications. As I continue striving to become a senior engineer, I’ve been learning to handle ambiguity by asking better questions. While this matters from a product perspective (as I've already mentioned), it also matters from a personal growth perspective, as this is a skill that I will continue to use for the rest of my career.
